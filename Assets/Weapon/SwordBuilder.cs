...
public static class SwordBuilder
{
    ...
    public static GameObject Build(CustomWeaponSO data, Transform parent = null)
    {
        ...
        blade.transform.position += new Vector3(0, guardRenderer.bounds.size.y, 0);
    ...
    static void SpawnWeapon(GameObject humain , CustomWeaponSO weapon)
    {
        GameObject newWeapon = Build(weapon);
        newWeapon.transform.SetParent(humain.transform);
        ...
        Animator animator = newWeapon.AddComponent<Animator>();
